  ...
  <section id='features'>
    <div className='py-4 flex flex-col gap-4 justify-center items-center' style={{ height: 'calc(100vh - 64px)' }}>
      ...
      <div className='flex flex-wrap gap-8 justify-center'>
        ...
        <Feature title='Concurrent Processing' description='Utilize multiple threads to process large amounts of data' href='/docs/latest/concurrent-processing' />
      </div>
    </div>
  </section>
